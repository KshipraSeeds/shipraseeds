    ...
    return (
        <div className="fixed inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-xl shadow-2xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto relative animate-scale-in">
                <h2 className="font-montserrat text-2xl font-bold text-shipra-green-700 mb-4 border-b pb-2 font-heading3">{title}</h2>
                <div className="text-shipra-text text-base leading-relaxed font-sans3">
                    {children}
                </div>
                <button
                    onClick={onClose}
