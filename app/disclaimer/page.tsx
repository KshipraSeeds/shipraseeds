...
const DisclaimerPage: React.FC = () => {
  ...
  // Animation variants for individual items/paragraphs
  const itemVariants = {
  ...
  <div className="m-4 rounded-[30px] sm:rounded-[42px]  flex items-center justify-center ">
    <div className="w-full max-w-4xl border-green-100  sm:p-8 md:p-10 space-y-10">
      <motion.header
        ...
        className="text-center mb-10 mt-6 md:mt-10"
      >
      ...
      <motion.section
        ...
        variants={sectionVariants}
        className="bg-white rounded-3xl shadow-xl p-6 sm:p-8 md:p-10 mb-12 border-t-8 border-green-500"
      >
      ...
      <motion.section
        ...
        viewport={{ once: true, amount: 0.2 }}
        variants={sectionVariants}
        className="bg-white rounded-3xl shadow-xl p-6 sm:p-8 md:p-10 mb-12 border-t-8 border-yellow-500"
      >
        ...
        <motion.p
          variants={itemVariants}
          className="mb-6 text-lg leading-relaxed text-gray-700 font-semibold"
        >
          {cardData.item28?.[language] || cardData.item28?.hi}
        </motion.p>
        <ul className="list-disc pl-5 space-y-3 text-gray-700">
          <motion.li variants={itemVariants}>
            {cardData.item29?.[language] || cardData.item29?.hi}
          </motion.li>
          <motion.li variants={itemVariants}>
            {cardData.item30?.[language] || cardData.item30?.hi}
          </motion.li>
          <motion.li variants={itemVariants}>
            {cardData.item31?.[language] || cardData.item31?.hi}
          </motion.li>
          <motion.li variants={itemVariants}>
            {cardData.item32?.[language] || cardData.item32?.hi}
          </motion.li>
          <motion.li variants={itemVariants}>
            {cardData.item33?.[language] || cardData.item33?.hi}
          </motion.li>
          <motion.li variants={itemVariants}>
            {cardData.item34?.[language] || cardData.item34?.hi}
          </motion.li>
        </ul>
        <motion.p
          variants={itemVariants}
          className="mt-6 text-lg leading-relaxed text-gray-700 italic"
        >
      ...
      <motion.section
        ...
        viewport={{ once: true, amount: 0.2 }}
        variants={sectionVariants}
        className="bg-white rounded-3xl shadow-xl p-6 sm:p-8 md:p-10 mb-12 border-t-8 border-blue-500"
      >
